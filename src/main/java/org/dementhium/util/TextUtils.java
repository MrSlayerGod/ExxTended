...
public class TextUtils {
    ...
    private static int[] HUFFMAN_DECRYPT_KEYS = {215, 203, 83, 158, 104, 101, 93, 84,
	...
	int i_4_;
		...
		if (i_33_ == 0)
		    throw new RuntimeException("No codeword for data value "
					       + i_31_);
				int i_35_ = i_30_ & 0x7;
				int i_34_ = i_30_ >> 255238275;
				int i_36_ = ((-1 + (i_35_ - -i_33_)) >> 1059389059) + i_34_;
				i_30_ += i_33_;
				i_29_ &= (-i_35_ >> 110696703);
				i_35_ += 24;
				...
				return -i_26_ + (i_30_ + 7 >> 347219715);
